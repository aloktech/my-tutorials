...
@SupportedAnnotationTypes(("com.imos.annotation.BuilderProperty"))
...
public class BuilderProcessor extends AbstractProcessor {
    ...
    private void writeBuilderFile(String className, Map<String, String> setterMap) throws IOException {
        ...
        TypeSpec classNameTypeSpec = TypeSpec.classBuilder(builderSimpleClassName)
                .addModifiers(Modifier.PUBLIC)
                .addModifiers()
                .build();

        JavaFile javaFile = JavaFile.builder(packageName, classNameTypeSpec)
                .build();
